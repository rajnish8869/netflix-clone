  ...
  render: function() {
    return (
      <div className="UserProfile">
        <div className="User">
          <div className="name">Rajnish Kumar</div>
...
var Hero = React.createClass({
  render: function() {
    return (
      <div id="hero" className="Hero" style={{backgroundImage: 'url(https://images3.alphacoders.com/103/1033561.jpg)'}}>
        <div className="content">
        <img className="logo" src="https://www.seekpng.com/png/detail/106-1060901_version-john-wick-movie-logo.png" alt="Version - John Wick Movie" />
